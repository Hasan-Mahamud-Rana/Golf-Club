...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
	...
	// Table responsive
    wp_enqueue_script( 'responsive-tables-js', get_template_directory_uri() . '/assets/js/responsive-tables.js', array( jquery ), '', true );
	wp_enqueue_style( 'responsive-tables-css', get_template_directory_uri() . '/assets/css/responsive-tables.css', array(), '', 'all' );
